...
to do some code auto-generation. Install uv following its `docs <https://docs.astral.sh/uv/getting-started/installation>`.

You can install and activate pre-commit with these commands:
...
Run Type Checking
-----------------
This repository uses `BasedPyright <https://github.com/DetatchHead/basedpyright>`_ for static type checking. The project currently maintains a type error baseline, as there are a number of pre-existing errors that have not yet been addressed.
